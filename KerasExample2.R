...
##Another simple example where the ML algorithm needs to find a separating hyperplane
## Everything around a point will be a 1 elsewhere will be a 0
...
thepoint <- matrix(c(.65,.8),nrow=1,ncol=2)
points(thepoint, pch=16,col='red',cex=2)
error <- .1
